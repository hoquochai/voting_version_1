                                                        ...
                                                        @if (auth()->check() && ! $isUserVoted || ! auth()->check() && ! $isParticipantVoted)
                                                            <center>
                                                                @if ($poll->multiple == trans('polls.label.multiple_choice'))
                                                                    {!! Form::checkbox('option[]', $option->id, false, ['class' => 'poll-option', 'onClick' => 'voted("' . $option->id  .'")']) !!}
                                                                @else
                                                                    {!! Form::radio('option[]', $option->id, false, ['class' => 'poll-option', 'onClick' => 'voted("' . $option->id  .'")']) !!}
                                                                @endif
                                                            </center>
                                                        @endif
                                                    </div>
